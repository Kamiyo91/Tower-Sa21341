    ...
    public class VortexInit : ModInitializer
    {
        ...
        private static void OnInitCards()
        {
            ModParameters.CardOptions.Add(VortexModParameters.PackageId, new List<CardOptions>
            {
                ...
                new CardOptions(87, CardOption.EgoPersonal),
        ...
        private static void OnInitCustomSkins()
        {
            ModParameters.CustomBookSkinsOptions.Add(VortexModParameters.PackageId, new List<CustomBookSkinsOption>
            {
                ...
                new CustomBookSkinsOption("Miyu_Sa21341", 10000003, characterNameId: 4, iconId: "MagicStaff_Sa21341"),
        ...
        private static void OnInitSprites()
        {
            ModParameters.SpriteOptions.Add(VortexModParameters.PackageId, new List<SpriteOptions>
            {
                ...
                new SpriteOptions(SpriteEnum.Custom, 10000006, "GreenDefault_Sa21341"),
